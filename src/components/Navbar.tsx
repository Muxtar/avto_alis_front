    ...
    <nav className="border-b border-card-border glass sticky top-0 z-50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 gap-2">
          <a href="/elanlar" className="flex items-center shrink-0 group">
          ...
          <div className="hidden sm:flex items-center gap-1 px-2 sm:px-4">
            <Link href="/elanlar" className="px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium text-muted hover:text-foreground hover:bg-input-bg transition-all whitespace-nowrap">
              {t("marketplace")}
            </Link>
            <Link
              href="/locations"
