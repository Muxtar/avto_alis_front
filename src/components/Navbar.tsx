                    ...
                    <div className="absolute right-0 mt-2 w-56 max-w-[calc(100vw-1.5rem)] bg-card border border-card-border rounded-xl shadow-xl overflow-hidden z-50 max-h-[calc(100vh-5rem)] overflow-y-auto">
                      ...
                      {outOpen && (
                        <div className="bg-input-bg/40">
                          ...
                          <Link href="/consultations" onClick={() => setUserOpen(false)} className="flex items-center gap-2 pl-11 pr-4 py-2.5 text-sm hover:bg-input-bg transition-colors text-foreground">
                            <span className="w-4 h-4 text-muted flex items-center justify-center">🗣️</span>
                            Rəy konsultasiyalarım
                          </Link>
                      ...
                      {inOpen && (
                        <div className="bg-input-bg/40">
                          ...
                          <Link href="/business" onClick={() => setUserOpen(false)} className="flex items-center gap-2 pl-11 pr-4 py-2.5 text-sm hover:bg-input-bg transition-colors text-foreground">
