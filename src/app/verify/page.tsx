    ...
    <div className="min-h-[calc(100vh-56px)] sm:min-h-[calc(100vh-64px)] flex items-center justify-center px-3 sm:px-4">
      <div className="w-full max-w-md">
        <div className="bg-card border border-card-border rounded-2xl p-6 sm:p-8">
          ...
          {/* Real göndərmə (Infobip SMS konfiqurasiyalı) — test kodu yoxdur:
              istifadəçiyə kodun SMS-ə getdiyini bildir. */}
          {!testCode && (
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-3 mb-6 text-center">
              <p className="text-green-500 text-xs font-medium">📱 Doğrulama kodu SMS ilə nömrənizə göndərildi. Kodu aşağıda daxil edin.</p>
            </div>
          )}

          {/* TEST MODE Banner - yalnız test rejimində (show_dev_code / otp_real off) göstərilir */}
          {testCode && (
