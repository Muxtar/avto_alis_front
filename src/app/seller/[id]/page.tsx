        ...
        <div className="flex flex-col sm:flex-row items-start gap-5">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-muted mb-4">
              {/* Telefon nömrəsi göstərilmir — əlaqə yalnız sayt daxili chat ilə. */}
              ...
              {(user.professions?.length ? user.professions : (user.profession ? [user.profession] : [])).length > 0 && (
                <span className="flex items-center gap-1.5 flex-wrap">
                  ...
                  {(user.professions?.length ? user.professions : [user.profession]).map((pr: string) => (
